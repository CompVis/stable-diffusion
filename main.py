...
from ldm.util import instantiate_from_config, send_message_to_slack, send_image_to_slack
...
class ImageLogger(Callback):
    def __init__(self, batch_frequency, max_images, clamp=True, increase_log_steps=True,
                 ...
                 log_to_slack=None, log_images_kwargs=None):
        super().__init__()
    ...
    def log_local(self, save_dir, split, images,
        ...
        for k in images:
            ...
            if self.log_to_slack and k in self.log_to_slack:
                send_image_to_slack("A new image is generated by the diffusion model: ", path)
