...
from stablediffusion.ldm.util import instantiate_from_config, parallel_data_prefetch
...
from stablediffusion.ldm.modules.encoders.modules import FrozenClipImageEmbedder, FrozenCLIPTextEmbedder
