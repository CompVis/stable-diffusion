...
def txt2img(
    ...
    print(f"TODO: Implement device switching, device={device}")
    print(f"TODO: Implement precision switching, precision={precision}")
    print(f"TODO: Implement tiling, tilingX={tilingX}, tilingY={tilingY}")
    ...
    rd.logger(
        f"\n[#48a971]Text to Image[white] generating for [#48a971]{n_iter}[white] iterations with [#48a971]{inference_steps}[white] steps per iteration at [#48a971]{width}[white]x[#48a971]{height}"
    )
